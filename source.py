...
decade_avg = nchs.groupby("Decade")["Mortality_ratio"].mean().reset_index()

plt.figure(figsize=(7,4))
plt.bar(decade_avg["Decade"].astype(str), decade_avg["Mortality_ratio"], color="teal")
...
plt.hist(nchs["Mortality_ratio"], bins=10, color="darkred", edgecolor="white")
